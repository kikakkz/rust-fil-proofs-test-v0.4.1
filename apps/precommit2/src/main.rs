        ...
        s.spawn(move |_| {
            for i in 0..config_count {
                ...
                while node_index != nodes_count {
                    ...
                    println!("processing config {}/{} with column nodes {}", i + 1, tree_count, chunked_nodes_count);
                    ...
                    println!("node index {}/{}/{}", node_index, chunked_nodes_count, nodes_count);
